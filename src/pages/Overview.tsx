...
export default function Overview() {
  ...
  const showForm = !plan || showNewPlanForm
  ...
  return (
    <div className="space-y-6">
      {showForm && (
        <section className="page-shell animate-in fade-in slide-in-from-top-2 duration-300">
                ...
                <div className="flex items-center gap-2">
                  {plan && (
                    <button
                      ...
                      className="focus-ring rounded-lg border border-slate-300 px-4 py-2.5 text-sm font-medium text-slate-700 hover:bg-slate-50"
                    >
                      Cancel
                    </button>
                  )}
