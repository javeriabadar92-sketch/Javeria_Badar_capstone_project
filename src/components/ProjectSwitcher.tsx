...
import { ChevronDown, FolderOpen, Pencil, Check, X, Trash2 } from 'lucide-react'
              ...
              {projects.map((project) => (
                <li key={project.id}>
                  {editingId === project.id ? (
                    ...
                    <div className={`group flex items-center ${project.id === activeProjectId ? 'bg-[#ECFEFF]' : ''}`}>
                      <button
                        type="button"
                      ...
                      <button
                        ...
                        className="focus-ring rounded p-1.5 text-slate-500 opacity-70 transition-opacity hover:bg-slate-50 hover:text-slate-700 group-hover:opacity-100"
                      >
                      ...
                      <button
                        ...
                        className="focus-ring mr-1 rounded p-1.5 text-slate-400 opacity-70 transition-opacity hover:bg-red-50 hover:text-red-600 group-hover:opacity-100"
                      >
